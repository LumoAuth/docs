...
const sidebars = {
  docs: [
    ...
    // ── AI Agent Identity ──
    {
      ...
      items: [
        { type: 'doc', id: 'agents/registry', label: 'Agent Registry' },
        ...
        { type: 'doc', id: 'agents/jit', label: 'JIT Permissions' },
        { type: 'doc', id: 'agents/delegation', label: 'Chain of Agency' },
        { type: 'doc', id: 'agents/aauth-quickstart', label: 'AAuth Quick Start' },
      ],
    },
    // ── MCP Servers ──
    {
